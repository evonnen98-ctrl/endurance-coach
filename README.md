...
## Features
* **Personalized onboarding:** Captures goals, fitness level, training history, and schedule.
...
## Key Learnings
* **The limits of raw LLMs:** Fully AI-generated training plans produced inconsistent outputs for structured calendar planning.
